		...
		nombreAdmin = ventanaBienvenida.txt;
     		...
     		miCalculo.setForeground(new Color(255, 0, 0));
      		...
      		textarea1.setText("\n   Aqi aparece el resultado del calculo de las vacaciones.");
		...
		JOptionPane.showMessageDialog(null, "Desarrollado por Kuster Joaquin\n" +
					            "www.facebook.com/joaquin.kuster.3");
        }
   	}
